...
class DatabaseHelper {
  ...
  Future<int> insertWatchlistSeries(TvSeriesTable movie) async {
    final db = await database;
    return await db!.insert(_tblWatchlistSeries, movie.toJson());
  }
  ...
  Future<int> removeWatchlist(MovieTable movie) async {
   ...
   Future<int> removeWatchlistSeries(TvSeriesTable movie) async {
    final db = await database;
    return await db!.delete(
      _tblWatchlistSeries,
      where: 'id = ?',
